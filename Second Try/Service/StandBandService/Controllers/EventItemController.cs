...
namespace StandBandService.Controllers
{
    public class EventItemController : TableController<EventItem>
    {
        ...
        public SingleResult<EventItem> GetItem(string id)
        {
            return Lookup(id);
        }

        // PATCH tables/Item/48D68C86-6EA6-4C25-AA33-223FC9A27959
        public Task<EventItem> PatchItem(string id, Delta<EventItem> patch)
        {
            return UpdateAsync(id, patch);
        }

        // POST tables/Item
        public async Task<IHttpActionResult> PostItem(EventItem item)
        {
